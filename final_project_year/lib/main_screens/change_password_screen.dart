...
class _ChangePasswordScreenState extends State<ChangePasswordScreen> {
  ...
  Widget build(BuildContext context) {
    return Container(decoration:BoxDecoration(color: Colors.transparent,image: DecorationImage(fit: BoxFit.cover,image: AssetImage('assets/images/farm.jpg'))),
      child: Directionality(textDirection: TextDirection.rtl,
        child: Scaffold(backgroundColor: Colors.transparent,drawer: MainDrawer(index: 10,),
          ...
          body: Center(
            child: Container(width: 600,color: Colors.white.withOpacity(0.5),
