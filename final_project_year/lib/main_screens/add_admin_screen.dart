...
class AddAdmin extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
     return Directionality(textDirection: TextDirection.rtl,
      child: Scaffold( appBar: AppBar(backgroundColor: Colors.brown ,elevation: 0,title: Text('تسجيل المدرين'),),backgroundColor: Colors.white,drawer: MainDrawer(index:9),   body: SingleChildScrollView(
