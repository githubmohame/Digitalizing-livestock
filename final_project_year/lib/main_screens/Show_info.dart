...
class ShowInfoScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Directionality(
      ...
      child: Scaffold(
        appBar: PreferredSize(preferredSize: Size(double.infinity,70-14),child: Directionality(textDirection: TextDirection.ltr,child: AppBar(backgroundColor: Colors.green,title:Center(child: Text("عرض معلومات المربي"),)))),
        body: SafeArea(
          child: LayoutBuilder(
            builder: (context,con) {
              return Container(width: con.maxWidth> 800?con.maxWidth:800,
                child: SingleChildScrollView(scrollDirection: Axis.horizontal,
                  child: Container(width: con.maxWidth> 800?con.maxWidth:800,
                    child: Column(
                                      ...
                                      return Container(
                                        ...
                                        child: Row(
                                            ...
                                            children: [
                                              Expanded(
                                                  child: Container(
                                                      child: Text("5tty667yyyuuuuiioo"))),
                                              Expanded(
                                                  child:
                                                      Container(child: Text("128797"))),
                                              Expanded(
                                                  child: Container(
                                                      child: Text("اافغغععهعاففققثث"))),
                                              Expanded(
                                                  child: Container(
                                                      child: Text("896667787666689"))),
                                              Expanded(
                                                child: Container(
                                                    child: Checkbox(
                                                  value: true,
