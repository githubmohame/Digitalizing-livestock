...
///
/// Used by [CustomeStepper.controlsBuilder].
@immutable
class ControlsDetails {
  ...
  /// Index that is active for the surrounding [CustomeStepper] widget. This may be
  ...
  /// just activated the transition to a new step, some [CustomeStepper.type] values will
...
/// A material step used in [CustomeStepper]. The step can have a title and subtitle,
...
///  * <https://material.io/archive/guidelines/components/steppers.html>
  /// Creates a step for a [CustomeStepper].
  ///
...
class _CustomeStepperState extends State<CustomeStepper>
  ...
  @override
  void didUpdateWidget(CustomeStepper oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    assert(() {
      if (context.findAncestorWidgetOfExactType<CustomeStepper>() != null) {
        throw FlutterError(
